...
const handleNewUser = async (req, res) => {
    ...
    */
    ...
    /*
    const { user,  pwd, firstName, lastName, uniid, stamClass, cpr, address, postal, city, mail, mobile} = req.body;
    if (!user || !pwd || !firstName || !lastName || !uniid || !stamClass || !cpr || !address || !postal || !city || !mail || !mobile) return res.status(400).json({ 'message': 'All fields are required.' });    
    */
